...
type AuthenticateUserResponse struct {
	...
	RefreshTokenJwt string                 `protobuf:"bytes,4,opt,name=refresh_token_jwt,json=refreshTokenJwt,proto3" json:"refresh_token_jwt,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *AuthenticateUserResponse) GetRefreshTokenJwt() string {
	if x != nil {
		return x.RefreshTokenJwt
	}
	return ""
}
...
const file_tasknexus_authentication_v1_authentication_proto_rawDesc = "" +
	...
	"\x11refresh_token_jwt\x18\x04 \x01(\tR\x0frefreshTokenJwt2\x98\x01\n" +
